...
public final class WidgetData {
    ...
    public static final List<WidgetData> ALL = Arrays.asList(
        ...
        new WidgetData("clock-orbit", "Clock", "Orbit Clock", "ساعة المدار", "Progressive day ring", "حلقة تقدم اليوم", false, false, 1),
        ...
        new WidgetData("weather-aura", "Weather", "Weather Aura", "هالة الطقس", "Forecast and freshness", "توقعات وحالة التحديث", true, false, 4),
        ...
        new WidgetData("system-pulse", "System", "System Pulse", "نبض النظام", "Battery and storage", "البطارية والتخزين", false, false, 7),
        new WidgetData("apps-lens", "Apps", "Apps Lens", "عدسة التطبيقات", "Expandable app folder", "مجلد تطبيقات قابل للتوسيع", true, false, 8),
        new WidgetData("sports-score", "Sports", "Score Glass", "زجاج النتائج", "Favorite teams first", "فرقك المفضلة أولًا", true, false, 9),
        new WidgetData("quote-calm", "Quotes", "Calm Quote", "اقتباس هادئ", "Daily Arabic and English", "عربي وإنجليزي يوميًا", false, false, 10),
        new WidgetData("calendar-arc", "Date", "Calendar Arc", "قوس التقويم", "Month progress", "تقدم الشهر", false, false, 11)
    );
}
